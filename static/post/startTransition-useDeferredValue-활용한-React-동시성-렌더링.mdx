---
slug: startTransition-useDeferredValue-활용한-React-동시성-렌더링
date: 2024-12-09
title: startTransition, useDeferredValue 활용한 React 18 동시성 렌더링
summary: React 18 동시성렌더링을 지원하는 3가지 함수를 배웁니다.
tags: [React, 공식문서]
---

![](https://velog.velcdn.com/images/skiende74/post/bbe8bf73-fdec-4a80-8508-304b863b9611/image.png)
...
![](https://velog.velcdn.com/images/skiende74/post/cacd7776-f688-4f2b-a29c-5444ef9ac7cb/image.png)

#### [영상] 버전0. 최적화 적용 전

![](https://velog.velcdn.com/images/skiende74/post/783874d2-f2b5-48ee-aab0-10f8099736c7/image.gif)
...
![](https://velog.velcdn.com/images/skiende74/post/8cfd9acb-1581-4b05-8b1e-0397a9a35127/image.gif)
...
![](https://velog.velcdn.com/images/skiende74/post/5ef64a26-5993-4850-8ead-f93e0d4b6049/image.gif)
...
![](https://velog.velcdn.com/images/skiende74/post/607441c7-c53f-496d-bfc9-2c0b32e58162/image.gif)
...
![](<![](https://velog.velcdn.com/images/skiende74/post/bcb9d6a9-dad4-443f-8b19-8f909ef82341/image.png)>)
...
### transition으로 지정해준다고 리액트의 동작을 막지않는 이유가 뭐죠?

'그 함수자체가 오래걸리면 결국 그동안은 main 스레드를 블로킹하는 것 아닐까요? 어떻게 리액트의 동작을 막지 않을까요?'

'JS엔진은 싱글스레드이니까 유휴시간에 작동을 시작하더라도 main 스레드에서 동작하므로 함수자체의 동작이 오래걸리면 JS를 블로킹하는 게 아닌가요?' 와 같은 의문을 가지실 수 있습니다.
